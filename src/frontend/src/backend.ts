...
export class Backend implements backendInterface {
    ...
    async addTask(arg0: string, arg1: string, arg2: Array<bigint>, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllUsersSummary(): Promise<Array<{
        taskCount: bigint;
        userPrincipal: string;
    }>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllUsersSummary();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCompletionsForDate(arg0: string): Promise<Array<DailyCompletion>> {
        if (this.processError) {
            try {
    ...
    async markTaskDone(arg0: bigint, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.markTaskDone(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async unmarkTaskDone(arg0: bigint, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.unmarkTaskDone(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTask(arg0: bigint, arg1: string, arg2: string, arg3: Array<bigint>, arg4: string): Promise<boolean> {
        if (this.processError) {
            try {
